...
import pigIcon from '../../images/pigicon.svg'

import callIcon from '../../icons/call-outline.svg'
				...
				<div className='row align-items-top text-center'>
					<div className='col-12 col-sm-6 col-md-4 col-lg-3 text-sm-left'>
						...
						<nav className='nav flex-column'>
							<NavLink to='/' replace className='nav-item'>
					...
					<div className='col-12 col-md-4 col-lg-3 text-md-left mt-5 mt-md-0'>
						...
						<p>
							We are a community dedicated to achieving personal
							financial freedom.
						</p>
					</div>
